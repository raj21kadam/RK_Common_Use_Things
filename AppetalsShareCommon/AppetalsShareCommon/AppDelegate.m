...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    Appetals_Share_VC *moveTo = [[Appetals_Share_VC alloc] initWithNibName:@"Appetals_Share_VC" bundle:nil];
    self.nav = [[UINavigationController alloc] initWithRootViewController:moveTo];
